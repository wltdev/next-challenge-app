    ...
    <div class="shadow-lg card blur">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configurações do Layout</h5>
        </div>
      ...
      <div class="pt-0 card-body pt-sm-3">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Sidebar - Cores dos icones</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Sidebar Tipo</h6>
          <p class="text-sm">Dois tipos possiveis</p>
        </div>
        <div class="d-flex">
          <button
            id="btn-transparent"
